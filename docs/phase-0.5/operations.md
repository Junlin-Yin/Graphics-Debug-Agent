# Phase 0.5 Operations

## Purpose

This document is the Phase 0.5 operational contract registry. It defines how build, test, lint, and verification commands are discovered, approved, promoted, and deprecated.
...
For Phase 0.5, narrow verification should prefer tests for:

- REPL view/controller behavior
- prompt history and multiline input
- tool result preview formatting
- streaming event mapping
- non-streaming provider fallback
- TTY and non-TTY view selection
- one-shot output preservation
...
These commands are canonical for Phase 0.5 verification:
